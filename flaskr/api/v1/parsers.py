...
from flaskr.api.v1.config import pod_num
...
cucm_add_phone_query_args.add_argument('description', type=str, required=False, help='Phone Device Description', default='Cisco Live HOLCOL2574 - pod31ucmuser', location='args')
...
cucm_add_phone_query_args.add_argument('ownerUserName', type=str, required=True, help='Device Owner User Name', default='pod31ucmuser', location='args')
cucm_add_phone_query_args.add_argument('calleridname', type=str, required=True, help='Line 1 Caller ID Name', default='Pod31 UCM User', location='args')
...
wbxc_enable_user_args.add_argument('license', type=str, required=False,
                                   choices=['Webex Calling - Professional', 'Webex Calling - Basic'],
                                   default='Webex Calling - Professional',
                                   help='License Level',
                                   location='args')
wbxc_enable_user_args.add_argument('location', type=str, required=False,
                                   ...
                                   default='Pod' + pod_num.zfill(2),
                                   help='Webex Calling Location name',
                                   location='args')
wbxc_enable_user_args.add_argument('phone_number', type=str, required=True,
                                   help='Work Phone Number',
                                   location='args')
